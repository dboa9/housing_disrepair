...
class PhotoRenamer:
    ...
    def rename_photos(self, directory, test_mode=True):
        ...
        try:
            ...
            # Get list of image files in the main directory only
            ...
            moved_files = [f for f in os.listdir(backup_dir) if f.lower().endswith(('.jpg', '.jpeg', '.png'))]
